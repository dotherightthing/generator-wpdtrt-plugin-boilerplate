...
module.exports = class extends Generator {
  ...
  */
  ...
  writing() {
    ...
    this.fs.copyTpl(
      this.templatePath( 'src/class-wpdtrt-plugin-boilerplate-rewrite'
    + '.php' ),
    ...
    this.fs.copyTpl(
      this.templatePath( 'src/class-wpdtrt-plugin-boilerplate-shortcode'
    + '.php' ),
    ...
    this.fs.copyTpl(
      this.templatePath( 'src/class-wpdtrt-plugin-boilerplate-taxonomy'
    + '.php' ),
    ...
    this.fs.copyTpl(
      this.templatePath( 'template-parts/wpdtrt-plugin-boilerplate/'
    + 'content.php' ),
    ...
    this.fs.copyTpl(
      this.templatePath( 'config/naturaldocs/Project.txt' ),
      this.destinationPath( 'config/naturaldocs/Project.txt' ),
      userSettings
    );

    this.fs.copy(
      this.templatePath( 'docs/.gitkeep' ),
